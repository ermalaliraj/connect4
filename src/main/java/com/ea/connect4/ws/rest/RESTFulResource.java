package com.ea.connect4.ws.rest;
...
public class RESTFulResource {
    ...
    public CanvasDTO newCanvas( @PathParam("userId") String userId
		...
		try {
			...
			return canvas;
		} catch (CanvasAlreadyCreatedException e) {
			logger.debug("CanvasAlreadyCreatedException: ", e);
			throw new RESTFullException("Canvas already exist for the user "+userId+" Delete first, then create a new one.");
