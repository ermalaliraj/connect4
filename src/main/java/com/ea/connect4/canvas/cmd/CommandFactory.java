...
import static com.ea.connect4.canvas.cmd.Command.CMD_CREATE_CANVAS;
import static com.ea.connect4.canvas.cmd.Command.CMD_FILL;
import static com.ea.connect4.canvas.cmd.Command.CMD_HELP;
import static com.ea.connect4.canvas.cmd.Command.CMD_LINE;
import static com.ea.connect4.canvas.cmd.Command.CMD_RECTANGLE;

import com.ea.connect4.canvas.exception.CanvasException;
import com.ea.connect4.canvas.exception.CommandNotFoundException;
